...
- 🟡 **Pivot 4 · Communications** — **4A SHIPPED** _2026-07-07_ (fuses CIM & BCP §6–10 + Megan Whitshed's Crisis Communications Plan): exposure Levels 1–4, comms phases, spokesperson/media-handling protocol + reception script + social guardrails, extended stakeholder×channel model, MW's phase-tagged script library. See `docs/pivot4-comms-integration.md`. **4B NEXT:** Media Q&A / FAQ builder (~35 journalist questions → FAQ SSOT).
